  ...
  def claim
    if request.put?
      ...
      resource.reserve! do
        ...
        IM::Ronglian.send_templated_sms(resource.patient_user_phone, Settings.sms_templates.when_reserved_notify_user, resource.reserved_location, resource.doctor_user_name)
      end
